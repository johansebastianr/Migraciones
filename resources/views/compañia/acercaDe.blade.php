...
<div class="container">
        <h1 class="masthead-heading mb-0" style="color: #000; text-align: left; font-size: 45px;">Acerca de</h1>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="page-section-heading text-left text-black">
                <p class="lead" style="color: #221f1f; font-size:30px;">
                    Brew Ride se dedica a la mayor parte de la sociedad que se preocupa por la seguridad física de las personas, buscando la manera de crear conciencia sobre la toma de decisiones responsables en estos eventos donde el consumo de alcohol es muy común y puede, desafortunadamente, llevar a situaciones caóticas.

                    <br>
                    
                    En reconocimiento de que el alcohol es el principal factor de estas festividades, hemos desarrollado una solución innovadora y concreta: una plataforma diseñada específicamente para ofrecer alternativas seguras y responsables a quienes se encuentran en estado de embriaguez, atendiendo a las necesidades que ocurren en el día a día para que todos puedan disfrutar sin preocupaciones por sus seres queridos.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-1" style="text-align: left; margin-top: 24px">
                ...
                <a href="/acerca" style="text-decoration: none">
                    <p class="lead efecto-color" style="color: #8B4512">Acerca de</p>
                </a>
